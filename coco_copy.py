...
# ------------------------------------------------------------------
data = torch.load("data_root/data/real_data/coco/ids_500.pt", map_location="cpu")
...
# ------------------------------------------------------------------
dest_root = Path("data_root/data/real_data/coco/coco500")
...
print(f"Copied {len(val_ids_500) - len(missing)} / {len(val_ids_500)} images "
