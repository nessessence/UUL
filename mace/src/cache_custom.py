...
def main(args):   
    ...
    total_prompts = args.prompt.split(';')
    ...
    torch.save(cache_dict, f"data_root/cache/mace/{args.output_file_name}.pt")
    

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--prompt",type=str,default=None,help="seperated by ; ",)
