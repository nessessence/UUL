...
accelerate launch train_dreambooth_lora.py \
    ...
    --load_lora_weight_path="data_root/logs/c.l4.kv_moodeng-sd-50.cbh_lr2.5e-4_f0.5_b1g4/checkpoint-2000" \
...
accelerate launch train_dreambooth_lora.py \
    ...
    --gen_image_path="auto" \
    --output_dir="data_root/logs/gen" \
    --load_lora_weight_path="data_root/logs/c.l4.kv_moodeng-sd-50.cbh_lr2.5e-4_f0.5_b1g4/checkpoint-2500" \
    --validation_prompt="A photo of a cute baby hippo" \
    --instance_prompt="A photo of a cute baby hippo" \
    --lora_rank 4 --target_lora_modules to_k to_v --target_lora_layers cross \
    --num_validation_images 50 \
