...
'
        ...
        --output_dir="data_root/logs/stereo/stereo_U.naked_sd1.4.bf16_r0/cce/uS0" \
...
'
                    accelerate launch train_dreambooth_lora.py \
                        ...
                        --run_note 'gen img' --wait_weight \
                        --num_validation_images 100 \
                        --load_token_embedding_path="data_root/logs/stereo/stereo_U.naked_sd1.4.bf16_r0/cce/uS1000" \
                        --placeholder_token="v1" --initializer_token='person' \
                        --cfg_scale 7.50 --gen_batch 10 --gen_dtype "bf16" 
echo 'count:1 - stereo_U.naked_sd1.4.bf16 0
'
                    accelerate launch train_dreambooth_lora.py \
                        --pretrained_model_name_or_path='CompVis/stable-diffusion-v1-4'  \
                        --load_unet_weight_path="data_root/logs/stereo/stereo_U.naked_sd1.4.bf16_r0/final_reo_unet.pt" \
                        ...
                        --cfg_scale 7.50 --gen_batch 10 --gen_dtype "bf16" 
echo 'count:2 - stereo_U.naked_sd1.4.bf16 0
'
                    accelerate launch train_dreambooth_lora.py \
                        --pretrained_model_name_or_path='CompVis/stable-diffusion-v1-4'  \
                        --load_unet_weight_path="data_root/logs/stereo/stereo_U.naked_sd1.4.bf16_r0/final_reo_unet.pt" \
                        ...
                        --cfg_scale 7.50 --gen_batch 10 --gen_dtype "bf16" 
echo 'count:3 - stereo_U.naked_sd1.4.bf16 0
'
                    accelerate launch train_dreambooth_lora.py \
                        --pretrained_model_name_or_path='CompVis/stable-diffusion-v1-4'  \
                        --load_unet_weight_path="data_root/logs/stereo/stereo_U.naked_sd1.4.bf16_r0/final_reo_unet.pt" \
