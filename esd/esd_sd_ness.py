...
if __name__ == '__main__':
    ...
    device = args.device
    torch_dtype = torch.bfloat16 # Fix to bfloat16 to float16 ?
    ...
    for iteration in pbar:
        ...
        loss = criteria(noise_pred_esd_model, noise_pred_erase_from - (negative_guidance*(noise_pred_erase - noise_pred_base))) 
        ...
        if args.preservation_weight is not None and args.preservation_weight > 0:
            ...
            loss = loss + args.preservation_weight*preservation_loss
            print(f"unlearn_loss: {unlearn_loss}, preservation_loss: {preservation_loss.item()}")
