...
class CustomDiffusionDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(f"prompt: {instance_prompt} and target: {instance_target}")  # Debug print
        # prompt: im not a robot im a machine and target: robot+r2d2
        # CA/assets/finetune_prompts/robot.txt
