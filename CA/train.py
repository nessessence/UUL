...
def parse_args(input_args=None):
    ...
    if args.with_prior_preservation:
        ...
        if args.class_data_dir is not None:
            print("Warning: You need not use --class_data_dir without --with_prior_preservation.") # my add
            warnings.warn(
                "You need not use --class_data_dir without --with_prior_preservation."
            )
        if args.class_prompt is not None:
            print("Warning: You need not use --class_prompt without --with_prior_preservation.") # my add
            warnings.warn(
