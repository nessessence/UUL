...
export pc_id="19_2"
    ...
    --output_dir="data_root/logs/ch.c.l16.kv_chiquita50-V_pr1.00_lr1e-4.ti5e-4_b4g4" \
    ...
    --pretrained_model_name_or_path=stablediffusionapi/chilloutmix  \
    --instance_data_dir=data_root/data/real_data/chiquita/chiquita-50 \
    --output_dir="data_root/logs/ch.c.l16.kv_chiquita50-V.r_pr1.00_lr5e-5.ti5e-4_b4g4" \
    --validation_prompt="a photo of v1" --instance_prompt="a photo of v1" \
    --train_batch_size=4 --gradient_accumulation_steps=4 \
    --lora_rank 16 --target_lora_modules to_k to_v --target_lora_layers cross \
    --max_train_steps=3000  --validation_steps=50  --checkpointing_steps=50 --seed 0 \
    ...
    --pretrained_model_name_or_path=stablediffusionapi/chilloutmix  \
    --instance_data_dir=data_root/data/real_data/chiquita/chiquita-50 \
    --output_dir="data_root/logs/ch.c.l16.kv_chiquita50-V_pr1.00_lr5e-5.ti5e-4_b4g4" \
    --validation_prompt="a photo of v1" --instance_prompt="a photo of v1" \
    --train_batch_size=4 --gradient_accumulation_steps=4 \
    --lora_rank 16 --target_lora_modules to_k to_v --target_lora_layers cross \
    --max_train_steps=3000  --validation_steps=50  --checkpointing_steps=50 --seed 0 \
    ...
    --learning_rate_lora 5e-5 --learning_rate_ti 5e-4 \
    --placeholder_token="v1" --initializer_token='person'
['ch.c.l16.kv_chiquita50-V.r_pr1.00_lr5e-4.ti5e-4_b4g4', 'ch.c.l16.kv_chiquita50-V_pr1.00_lr5e-4.ti5e-4_b4g4', 'ch.c.l16.kv_chiquita50-V.r_pr1.00_lr1e-4.ti5e-4_b4g4', 'ch.c.l16.kv_chiquita50-V_pr1.00_lr1e-4.ti5e-4_b4g4', 'ch.c.l16.kv_chiquita50-V.r_pr1.00_lr5e-5.ti5e-4_b4g4', 'ch.c.l16.kv_chiquita50-V_pr1.00_lr5e-5.ti5e-4_b4g4']
